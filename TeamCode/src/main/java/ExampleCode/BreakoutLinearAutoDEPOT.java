...
//import org.firstinspires.ftc.teamcode.BreakoutREVGyro;
//import org.firstinspires.ftc.teamcode.BreakoutServo;
//
//import java.io.File;
...
//
//@Autonomous(name = "DEPOT AUTO", group = "pushbot")
//
//public class BreakoutLinearAutoDEPOT extends LinearOpMode {
//
...
//            startTime.reset();
//            if (goldLoc == 0) {
//                while (opModeIsActive() && startTime.milliseconds() < 1500) {
//                    idle();
//                }
//                stopAllMotors();
//                while (opModeIsActive() && startTime.milliseconds() < 2250) {
//                    motorLeft.setPower(1);
//                    motorRight.setPower(-1);
//                }
//                stopAllMotors();
//                while (opModeIsActive() && startTime.milliseconds() < 2550) {
//                    motorSweeperArm.setPower(1);
//                }
//                stopAllMotors();
//                while (opModeIsActive() && startTime.milliseconds() < 3000) {
//                    idle();
//                }
//                while (opModeIsActive() && startTime.milliseconds() < 8000) {
...
//                    motorSweeperArm.setPower(1);
//                }
//                while (opModeIsActive() && startTime.milliseconds() < 6500) {
//                    motorSweeper.setPower(-1);
//                }
//                stopAllMotors();
//            }
