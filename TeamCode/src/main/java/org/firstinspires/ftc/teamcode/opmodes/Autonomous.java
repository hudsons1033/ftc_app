...
//        sleep(1000);     // pause for servos to move
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            frontLeftTarget = robot.getCurrentPosition(Robot.Motor.FRONT_LEFT) + (int)(leftInches * COUNTS_PER_INCH);
            frontRightTarget = robot.getCurrentPosition(Robot.Motor.FRONT_RIGHT) + (int)(rightInches * COUNTS_PER_INCH);
            backLeftTarget = robot.getCurrentPosition(Robot.Motor.FRONT_RIGHT) + (int)(rightInches * COUNTS_PER_INCH);
            backRightTarget = robot.getCurrentPosition(Robot.Motor.FRONT_RIGHT) + (int)(rightInches * COUNTS_PER_INCH);
            robot.setTargetPosition(frontLeftTarget);
